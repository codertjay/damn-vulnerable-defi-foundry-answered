...
import {NaiveReceiverAttacker} from "../../../src/Contracts/naive-receiver/NaiveReceiverAttacker.sol";
...
contract NaiveReceiver is Test {
    ...
    function setUp() public {
        ...
        naiveReceiverAttacker = new  NaiveReceiverAttacker(payable(naiveReceiverLenderPool));
    ...
    function testExploit() public {
        ...
        naiveReceiverAttacker.attack(address(flashLoanReceiver));
        /**
         * EXPLOIT END *
         */
        validation();
