...
import {TrusterAttacker} from "../../../src/Contracts/truster/TrusterAttacker.sol";
...
contract Truster is Test {
    ...
    TrusterAttacker internal trusterAttacker;
    ...
    function setUp() public {
        ...
        trusterAttacker = new TrusterAttacker(address(trusterLenderPool), address(dvt), attacker);
